...
class CustomHTTPClient:
    def __init__(self, api_key: str, proxy_url: str = None, max_retries: int = DEFAULT_MAX_RETRIES,
...
class LLM:
    def __init__(self, max_retries: int = DEFAULT_MAX_RETRIES, model_type: str = "openai",
                 prompt_file_path: str = "prompts/github_openai_report_prompt.txt", timeout: int = DEFAULT_TIMEOUT):
